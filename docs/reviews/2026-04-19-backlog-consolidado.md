# Backlog consolidado — estado em v0.5.4

**Data:** 2026-04-19
**Versão de referência:** v0.5.4
...
**v0.5.5 (9 itens — alto ROI):** 1, 2, 3, 4, 5 (todos os altos) + 6+7 (resolvidos juntos) + 8, 9.
**v0.5.6 (8 itens):** 10, 11, 12, 13, 14 + 24, 25, 26 (testes).
**v0.5.7 (9 itens):** 15, 16, 17, 18, 19, 20, 21, 22, 23 (polimento final antes do refactor de design).
**v0.6.0-alpha:** 27, 28, 29 (quebra de contrato — mini-spec próprio) + B3 (sugestões).

Total fora de v0.5.x: 4 itens (design + sugestões).
Total em v0.5.x: 25 itens.
